...
def test_client_default_user_agent(client, response):
    ...
    response.get("https://eu.middleware.ewarehousing-solutions.com/wms/orders/", "order_list")
    response.post("https://eu.middleware.ewarehousing-solutions.com/wms/auth/login/", "auth_login")
    client.order.list()
...
def test_client_auth(client, response):
    ...
    response.post("https://eu.middleware.ewarehousing-solutions.com/wms/auth/login/", "auth_login")
    response.post("https://eu.middleware.ewarehousing-solutions.com/wms/auth/refresh/", "auth_login_refresh")
    response.get("https://eu.middleware.ewarehousing-solutions.com/wms/orders/", "order_list")
...
def test_invalid_auth(client, response):
    ...
    response.post("https://eu.middleware.ewarehousing-solutions.com/wms/auth/login/", "auth_login_error", status=401)
