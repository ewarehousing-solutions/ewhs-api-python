def test_list_shipments(authenticated_client, response):
    ...
    response.get(f"https://api.ewarehousing.com/api/shipments", "shipment_list")
...
def test_filter_shipments(authenticated_client, response):
    """Retrieve a list of shipments"""
    response.get("https://api.ewarehousing.com/api/shipments?order_reference=VB_ORDER_001", "shipment_list")
...
def test_get_shipment(authenticated_client, response):
    ...
    response.get("https://api.ewarehousing.com/api/orders/1701bf71-0b9a-4984-bee5-c9e83b7d2c1d", "shipment_single")
